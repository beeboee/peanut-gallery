class PeanutGalleryCard extends HTMLElement {
  ...
  getImageEntity() { return this._hass?.states?.[this.config.image_entity]; }
  ...
  renderBase() {
    this.shadowRoot.innerHTML = `
      <style>
        ...
        .date-label { position: absolute; left: 8px; bottom: 8px; z-index: 4; padding: 6px 10px; border-radius: 999px; background: rgba(0,0,0,.55); color: white; font-size: 13px; line-height: 1; pointer-events: none; }
